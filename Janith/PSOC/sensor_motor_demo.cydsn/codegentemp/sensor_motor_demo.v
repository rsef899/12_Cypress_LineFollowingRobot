...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("8ce5a899-9ae2-438d-bdd5-d603b369c4d7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SEN_4_net;
	wire [0:0] tmpIO_0__SEN_4_net;
	wire [0:0] tmpINTERRUPT_0__SEN_4_net;
	electrical [0:0] tmpSIOVREF__SEN_4_net;

	cy_psoc3_pins_v1_10
		#(.id("e58aa763-363b-45e8-b7cb-ad8bb2e1fc8c"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		SEN_4
		 (.oe(tmpOE__SEN_4_net),
		  .y({1'b0}),
		  .fb({Net_4350}),
		  .io({tmpIO_0__SEN_4_net[0:0]}),
		  .siovref(tmpSIOVREF__SEN_4_net),
		  .interrupt({tmpINTERRUPT_0__SEN_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SEN_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__SEN_3_net;
	wire [0:0] tmpIO_0__SEN_3_net;
	wire [0:0] tmpINTERRUPT_0__SEN_3_net;
	electrical [0:0] tmpSIOVREF__SEN_3_net;

	cy_psoc3_pins_v1_10
		#(.id("3ea4dd36-d44f-4378-ad95-5b00a86bc6d4"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		SEN_3
		 (.oe(tmpOE__SEN_3_net),
		  .y({1'b0}),
		  .fb({Net_4351}),
		  .io({tmpIO_0__SEN_3_net[0:0]}),
		  .siovref(tmpSIOVREF__SEN_3_net),
		  .interrupt({tmpINTERRUPT_0__SEN_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SEN_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("6b96599b-6606-4e46-9054-b25d07c96c28"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("470dacc7-c2b1-4ef2-8099-1c0e66314203"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SEN_2_net;
	wire [0:0] tmpIO_0__SEN_2_net;
	wire [0:0] tmpINTERRUPT_0__SEN_2_net;
	electrical [0:0] tmpSIOVREF__SEN_2_net;

	cy_psoc3_pins_v1_10
		#(.id("0d29f9b9-815e-48d5-90d1-368a857428ca"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		SEN_2
		 (.oe(tmpOE__SEN_2_net),
		  .y({1'b0}),
		  .fb({Net_4352}),
		  .io({tmpIO_0__SEN_2_net[0:0]}),
		  .siovref(tmpSIOVREF__SEN_2_net),
		  .interrupt({tmpINTERRUPT_0__SEN_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SEN_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("126bf59f-88f2-47b1-a76b-6b90dceb9fe3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("512ad605-5d2d-4d7e-8d12-604953176ddb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SEN_5_net;
	wire [0:0] tmpIO_0__SEN_5_net;
	wire [0:0] tmpINTERRUPT_0__SEN_5_net;
	electrical [0:0] tmpSIOVREF__SEN_5_net;

	cy_psoc3_pins_v1_10
		#(.id("eaabc732-3d9e-4b82-9ca4-4fc1724db574"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		SEN_5
		 (.oe(tmpOE__SEN_5_net),
		  .y({1'b0}),
		  .fb({Net_4349}),
		  .io({tmpIO_0__SEN_5_net[0:0]}),
		  .siovref(tmpSIOVREF__SEN_5_net),
		  .interrupt({tmpINTERRUPT_0__SEN_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SEN_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    assign Net_4357 = 1'h1;
	...
	cy_psoc3_pins_v1_10
		#(.id("32117701-cc5c-49dc-9c6b-3f7fdb3c5d25"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SEN_1_net;
	wire [0:0] tmpIO_0__SEN_1_net;
	wire [0:0] tmpINTERRUPT_0__SEN_1_net;
	electrical [0:0] tmpSIOVREF__SEN_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		SEN_1
		 (.oe(tmpOE__SEN_1_net),
		  .y({1'b0}),
		  .fb({Net_4353}),
		  .io({tmpIO_0__SEN_1_net[0:0]}),
		  .siovref(tmpSIOVREF__SEN_1_net),
		  .interrupt({tmpINTERRUPT_0__SEN_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SEN_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("1de7a18a-5ed5-45a5-a266-a06a49d39972"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c99953df-6696-43d6-92af-90d948be238e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9d824637-56e1-4c21-9507-3e0ca16dbaa9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SEN_7_net;
	wire [0:0] tmpIO_0__SEN_7_net;
	wire [0:0] tmpINTERRUPT_0__SEN_7_net;
	electrical [0:0] tmpSIOVREF__SEN_7_net;

	cy_psoc3_pins_v1_10
		#(.id("4bf5a4b7-9141-40e5-ac37-cc4e153eabbd"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		SEN_7
		 (.oe(tmpOE__SEN_7_net),
		  .y({1'b0}),
		  .fb({Net_4347}),
		  .io({tmpIO_0__SEN_7_net[0:0]}),
		  .siovref(tmpSIOVREF__SEN_7_net),
		  .interrupt({tmpINTERRUPT_0__SEN_7_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SEN_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("8a23cafd-df1c-44da-a6f3-3c223d24f353"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SEN_6_net;
	wire [0:0] tmpIO_0__SEN_6_net;
	wire [0:0] tmpINTERRUPT_0__SEN_6_net;
	electrical [0:0] tmpSIOVREF__SEN_6_net;

	cy_psoc3_pins_v1_10
		#(.id("490c4040-d742-4335-86be-68ce48dabffd"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		SEN_6
		 (.oe(tmpOE__SEN_6_net),
		  .y({1'b0}),
		  .fb({Net_4348}),
		  .io({tmpIO_0__SEN_6_net[0:0]}),
		  .siovref(tmpSIOVREF__SEN_6_net),
		  .interrupt({tmpINTERRUPT_0__SEN_6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SEN_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("d6ed797a-15b1-4b55-8024-e18c53a31065"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
