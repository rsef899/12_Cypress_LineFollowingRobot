...
# Date: Wed, 20 Sep 2023 18:23:17 GMT
#set_units -time ns
...
create_generated_clock -name {Quad_Timer_clk} -source [get_pins {ClockBlock/clk_sync}] -edges {1 60001 120001} [list [get_pins {ClockBlock/dclk_glb_4}]]
create_generated_clock -name {Clock2} -source [get_pins {ClockBlock/clk_sync}] -edges {1 60001 120001} [list [get_pins {ClockBlock/dclk_glb_5}]]
...
# Project: H:\Documents\12_Cypress_LineFollowingRobot\Robert\HArdware_Task2\Hardware_Task2.cydsn\Hardware_Task2.cyprj
# Date: Wed, 20 Sep 2023 18:21:12 GMT
