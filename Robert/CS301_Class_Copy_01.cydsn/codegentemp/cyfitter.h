...
/* IN1A */
#define IN1A__0__INTTYPE CYREG_PICU3_INTTYPE1
#define IN1A__0__MASK 0x02u
#define IN1A__0__PC CYREG_PRT3_PC1
#define IN1A__0__PORT 3u
#define IN1A__0__SHIFT 1u
#define IN1A__AG CYREG_PRT3_AG
#define IN1A__AMUX CYREG_PRT3_AMUX
#define IN1A__BIE CYREG_PRT3_BIE
#define IN1A__BIT_MASK CYREG_PRT3_BIT_MASK
#define IN1A__BYP CYREG_PRT3_BYP
#define IN1A__CTL CYREG_PRT3_CTL
#define IN1A__DM0 CYREG_PRT3_DM0
#define IN1A__DM1 CYREG_PRT3_DM1
#define IN1A__DM2 CYREG_PRT3_DM2
#define IN1A__DR CYREG_PRT3_DR
#define IN1A__INP_DIS CYREG_PRT3_INP_DIS
#define IN1A__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU3_BASE
#define IN1A__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define IN1A__LCD_EN CYREG_PRT3_LCD_EN
#define IN1A__MASK 0x02u
#define IN1A__PORT 3u
#define IN1A__PRT CYREG_PRT3_PRT
#define IN1A__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define IN1A__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define IN1A__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define IN1A__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define IN1A__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define IN1A__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define IN1A__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define IN1A__PS CYREG_PRT3_PS
#define IN1A__SHIFT 1u
#define IN1A__SLW CYREG_PRT3_SLW

/* IN1B */
#define IN1B__0__INTTYPE CYREG_PICU1_INTTYPE6
#define IN1B__0__MASK 0x40u
#define IN1B__0__PC CYREG_PRT1_PC6
#define IN1B__0__PORT 1u
#define IN1B__0__SHIFT 6u
#define IN1B__AG CYREG_PRT1_AG
#define IN1B__AMUX CYREG_PRT1_AMUX
#define IN1B__BIE CYREG_PRT1_BIE
#define IN1B__BIT_MASK CYREG_PRT1_BIT_MASK
#define IN1B__BYP CYREG_PRT1_BYP
#define IN1B__CTL CYREG_PRT1_CTL
#define IN1B__DM0 CYREG_PRT1_DM0
#define IN1B__DM1 CYREG_PRT1_DM1
#define IN1B__DM2 CYREG_PRT1_DM2
#define IN1B__DR CYREG_PRT1_DR
#define IN1B__INP_DIS CYREG_PRT1_INP_DIS
#define IN1B__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define IN1B__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define IN1B__LCD_EN CYREG_PRT1_LCD_EN
#define IN1B__MASK 0x40u
#define IN1B__PORT 1u
#define IN1B__PRT CYREG_PRT1_PRT
#define IN1B__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define IN1B__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define IN1B__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define IN1B__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define IN1B__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define IN1B__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define IN1B__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define IN1B__PS CYREG_PRT1_PS
#define IN1B__SHIFT 6u
#define IN1B__SLW CYREG_PRT1_SLW

/* IN2A */
#define IN2A__0__INTTYPE CYREG_PICU1_INTTYPE2
#define IN2A__0__MASK 0x04u
#define IN2A__0__PC CYREG_PRT1_PC2
#define IN2A__0__PORT 1u
#define IN2A__0__SHIFT 2u
#define IN2A__AG CYREG_PRT1_AG
#define IN2A__AMUX CYREG_PRT1_AMUX
#define IN2A__BIE CYREG_PRT1_BIE
#define IN2A__BIT_MASK CYREG_PRT1_BIT_MASK
#define IN2A__BYP CYREG_PRT1_BYP
#define IN2A__CTL CYREG_PRT1_CTL
#define IN2A__DM0 CYREG_PRT1_DM0
#define IN2A__DM1 CYREG_PRT1_DM1
#define IN2A__DM2 CYREG_PRT1_DM2
#define IN2A__DR CYREG_PRT1_DR
#define IN2A__INP_DIS CYREG_PRT1_INP_DIS
#define IN2A__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define IN2A__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define IN2A__LCD_EN CYREG_PRT1_LCD_EN
#define IN2A__MASK 0x04u
#define IN2A__PORT 1u
#define IN2A__PRT CYREG_PRT1_PRT
#define IN2A__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define IN2A__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define IN2A__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define IN2A__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define IN2A__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define IN2A__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define IN2A__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define IN2A__PS CYREG_PRT1_PS
#define IN2A__SHIFT 2u
#define IN2A__SLW CYREG_PRT1_SLW

/* IN2B */
#define IN2B__0__INTTYPE CYREG_PICU1_INTTYPE4
#define IN2B__0__MASK 0x10u
#define IN2B__0__PC CYREG_PRT1_PC4
#define IN2B__0__PORT 1u
#define IN2B__0__SHIFT 4u
#define IN2B__AG CYREG_PRT1_AG
#define IN2B__AMUX CYREG_PRT1_AMUX
#define IN2B__BIE CYREG_PRT1_BIE
#define IN2B__BIT_MASK CYREG_PRT1_BIT_MASK
#define IN2B__BYP CYREG_PRT1_BYP
#define IN2B__CTL CYREG_PRT1_CTL
#define IN2B__DM0 CYREG_PRT1_DM0
#define IN2B__DM1 CYREG_PRT1_DM1
#define IN2B__DM2 CYREG_PRT1_DM2
#define IN2B__DR CYREG_PRT1_DR
#define IN2B__INP_DIS CYREG_PRT1_INP_DIS
#define IN2B__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define IN2B__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define IN2B__LCD_EN CYREG_PRT1_LCD_EN
#define IN2B__MASK 0x10u
#define IN2B__PORT 1u
#define IN2B__PRT CYREG_PRT1_PRT
#define IN2B__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define IN2B__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define IN2B__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define IN2B__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define IN2B__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define IN2B__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define IN2B__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define IN2B__PS CYREG_PRT1_PS
#define IN2B__SHIFT 4u
#define IN2B__SLW CYREG_PRT1_SLW
...
#define QuadDec_M1_Cnt16_CounterUDB_sSTSReg_stsreg__MASK_ST_AUX_CTL_REG CYREG_B1_UDB04_MSK_ACTL
#define QuadDec_M1_Cnt16_CounterUDB_sSTSReg_stsreg__PER_ST_AUX_CTL_REG CYREG_B1_UDB04_MSK_ACTL
#define QuadDec_M1_Cnt16_CounterUDB_sSTSReg_stsreg__STATUS_AUX_CTL_REG CYREG_B1_UDB04_ACTL
#define QuadDec_M1_Cnt16_CounterUDB_sSTSReg_stsreg__STATUS_CNT_REG CYREG_B1_UDB04_ST_CTL
#define QuadDec_M1_Cnt16_CounterUDB_sSTSReg_stsreg__STATUS_CONTROL_REG CYREG_B1_UDB04_ST_CTL
...
#define CY_PROJECT_NAME "CS301_Class_Copy_01"
