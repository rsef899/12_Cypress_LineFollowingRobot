...
# Date: Fri, 28 Jul 2023 09:05:45 GMT
#set_units -time ns
create_clock -name {ADC_IntClock(routed)} -period 633.33333333333326 -waveform {0 316.666666666667} [list [get_pins {ClockBlock/dclk_1}]]
...
create_generated_clock -name {ADC_IntClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 39 77} [list [get_pins {ClockBlock/dclk_glb_1}]]
...
# Project: C:\Users\schoo\302OffOnedrive\301 Project\12_Cypress_LineFollowingRobot\Robert\CS301_Class_Copy_01.cydsn\CS301_Class_Copy_01.cyprj
# Date: Fri, 28 Jul 2023 09:05:28 GMT
